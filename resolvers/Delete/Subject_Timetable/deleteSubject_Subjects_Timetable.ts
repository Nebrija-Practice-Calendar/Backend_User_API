...
export const deleteSubject_Subjects_Timetable = async (req: Request, res: Response) => {
  try {
    const {id,idxRange, day} = req.body;
    console.log(req.body);
    if(!id || !idxRange || day === undefined) {
    ...
    */
    Subjects_Timetables.Timetables[day].fill('-', idxRange[0], idxRange[1] + 1);
